...
| customArrows                  | [Square, Square, string?, number?]\[\]                                                    | array of string arrays                             | Array where each element is a tuple containing two Square values (representing the 'from' and 'to' squares), an optional third string element for the arrow color and an optional fourth number element for the arrow opacity e.g. [ ['a3', 'a5', 'red', 1], ['g1', 'f3'] ].                                                                                                                                                                            |
